...
describe('IconButton', () => {
  ...
  it('should apply primary mode when specified', () => {
    const { container } = render(<IconButton onClick={mockOnClick} icon={mockIcon} mode="primary" />)
  ...
  it('should apply light mode when explicitly specified', () => {
    const { container } = render(<IconButton onClick={mockOnClick} icon={mockIcon} mode="light" />)
  ...
  it('should apply rotation class when rotation is true', () => {
    const { container } = render(<IconButton onClick={mockOnClick} icon={mockIcon} rotation={true} />)
  ...
  it('should not apply rotation class when rotation is false', () => {
    const { container } = render(<IconButton onClick={mockOnClick} icon={mockIcon} rotation={false} />)
  ...
  it('should apply custom styles', () => {
    ...
    const { container } = render(<IconButton onClick={mockOnClick} icon={mockIcon} style={customStyle} />)
  ...
  it('should handle different icon paths', () => {
    const { rerender, container } = render(<IconButton onClick={mockOnClick} icon="/icon1.svg" />)
