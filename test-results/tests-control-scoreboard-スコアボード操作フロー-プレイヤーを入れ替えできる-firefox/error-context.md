...
- Name: スコアボード操作フロー >> プレイヤーを入れ替えできる
- Location: /Users/to-hutohu/workspace/BraceBracket/e2e/tests/control-scoreboard.spec.ts:72:7
...
Locator: getByTestId('p1-name')
Expected string: "Player2"
Received string: "P1 Name"
Call log:
  - expect.toHaveValue with timeout 5000ms
  - waiting for getByTestId('p1-name')
    8 × locator resolved to <input type="text" autocomplete="on" list="playerName" id="p1.playerName" name="p1.playerName" data-testid="p1-name" placeholder="1P Player" class="TextForm_input__7Mlhi"/>
      - unexpected value "P1 Name"

    at ControlPage.expectCurrentPlayerNames (/Users/to-hutohu/workspace/BraceBracket/e2e/pages/control.page.ts:159:52)
    at /Users/to-hutohu/workspace/BraceBracket/e2e/tests/control-scoreboard.spec.ts:86:23
```
