  ...
  describe('useMC', () => {
    ...
    it('should handle setValue function call', () => {
      ...
      const newMC = {
        ...defaultValue,
        mcList: [
          { team: 'Team1', playerName: 'Player1', twitterID: '@player1', score: 1 },
          { team: 'Team2', playerName: 'Player2', twitterID: '@player2', score: 2 },
    ...
    it('should support MC list with different lengths', () => {
      ...
      const customMC = {
        ...defaultValue,
        mcList: [
          { team: 'SingleTeam', playerName: 'SinglePlayer', twitterID: '@single', score: 5 }
        ]
      }
