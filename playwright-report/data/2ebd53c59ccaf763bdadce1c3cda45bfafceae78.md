...
Call log:
  ...
  - waiting for getByTestId('p1-score')
    2 × locator resolved to <input type="number" id="p1.score" name="p1.score" data-testid="p1-score" class="NumberForm_input__XW6Iu"/>
      - unexpected value "-1"
    7 × locator resolved to <input type="number" id="p1.score" name="p1.score" data-testid="p1-score" class="NumberForm_input__XW6Iu"/>
      - unexpected value "2"

    at ControlPage.expectCurrentScores (/Users/to-hutohu/workspace/BraceBracket/e2e/pages/control.page.ts:154:53)
    at /Users/to-hutohu/workspace/BraceBracket/e2e/tests/control-scoreboard.spec.ts:69:23
```
