...
<div className='columns is-variable is-6'>
  ...
  <div className="column is-hidden-touch is-hidden-desktop-only">
    <ul className={styles.index}>
      ...
      <li className={styles.index__sub}><Scroll smooth={true} duration={500} offset={-100} className="cursor-pointer" to="create__tweet">ツイート機能のテンプレートを作成する</Scroll></li>
...
export default ({children}) => <>
  <Head>
    ...
    <meta property="og:title" content="BraceBracket | How to Use" />
